...
function GR:CreateMainWindow()
    ...
    GR_GUI.Main.H1 =  GR_GUI.Main:CreateFontString(nil, "OVERLAY", "GameTooltipText")
    ...
    local HomeString = HomeBtn:CreateFontString(nil, "OVERLAY", "GameTooltipText")
...
function GR:CreateHeaderInfo()
    ...
    local ReInviteString = ReInvite:CreateFontString(nil, "OVERLAY", "GameTooltipText")
    ...
    local ReMatchString = ReMatch:CreateFontString(nil, "OVERLAY", "GameTooltipText")
    ...
    local RivalString = Rival:CreateFontString(nil, "OVERLAY", "GameTooltipText")
...
function GR:CreateAcceptDecline()
    ...
    local DeclineBtnString = DeclineBtn:CreateFontString(nil, "OVERLAY", "GameTooltipText")
    ...
    local Accept2String = Accept2:CreateFontString(nil, "OVERLAY", "GameTooltipText")
    ...
    Accept2.Fs2 = Accept2:CreateFontString(nil, "OVERLAY", "GameTooltipText")
    ...
    local DeclineBtn2String = DeclineBtn2:CreateFontString(nil, "OVERLAY", "GameTooltipText")
