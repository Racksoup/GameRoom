...
function GR:CreateInviteFriends()
    ...
    local FriendsString = FriendsScrollFrame:CreateFontString(nil, "ARTWORK", "GameTooltipText")
...
function GR:CreateInviteParty()
    ...
    local PartyString = PartyScrollFrame:CreateFontString(nil, "ARTWORK", "GameTooltipText")
...
function GR:CreateInviteZone()
    ...
    local ZoneReqString = ZoneReq:CreateFontString(nil, "ARTWORK", "GameTooltipText")
