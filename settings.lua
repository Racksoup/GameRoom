function GR:CreateSettings()
    ...
    local H2 = SettingsScroll:CreateFontString(nil, "ARTWORK", "GameTooltipText")
...
function GR:CreateMainSettings()
    local Settings = GR_GUI.Main.Settings
    -- Alpha Settings
    local AlphaString = Settings:CreateFontString(nil, "ARTWORK", "GameTooltipText")
    ...
    local BNString = Settings:CreateFontString(nil, "ARTWORK", "GameTooltipText")
    ...
    local IncString = Settings:CreateFontString(nil, "ARTWORK", "GameTooltipText")
    ...
    -- Whitelist Checkbox
    local WhitelistString = Settings:CreateFontString(nil, "ARTWORK", "GameTooltipText")
    ...
    local ShowChallengeString = Settings:CreateFontString(nil, "ARTWORK", "GameTooltipText")
    ...
    local MoveableChalString = Settings:CreateFontString(nil, "ARTWORK", "GameTooltipText")
    ...
    local MoveableChalBtnString = MoveableChalBtn:CreateFontString(nil, "ARTWORK", "GameTooltipText")
    ...
    local CombatString = Settings:CreateFontString(nil, "ARTWORK", "GameTooltipText")
    ...
    -- Whitelist Guild
    local WhiteGuildString = Settings:CreateFontString(nil, "ARTWORK", "GameTooltipText")
    ...
    -- Whitelist Party
    local WhitePartyString = Settings:CreateFontString(nil, "ARTWORK", "GameTooltipText")
    ...
    -- Whitelist Friends
    local WhiteFriendsString = Settings:CreateFontString(nil, "ARTWORK", "GameTooltipText")
...
function GR:CreateSettingsLists()
    ...
    local AddString = AddBtn:CreateFontString(nil, "ARTWORK", "GameTooltipText")
    ...
    local DeleteFS = Delete:CreateFontString(nil, "ARTWORK", "GameTooltipText")
    ...
    local BlacklistBtnFS = BlacklistBtn:CreateFontString(nil, "ARTWORK", "GameTooltipText")
    ...
    local WhitelistBtnFS = WhitelistBtn:CreateFontString(nil, "ARTWORK", "GameTooltipText")
    ...
    local RivalsBtnFS = RivalsBtn:CreateFontString(nil, "ARTWORK", "GameTooltipText")
